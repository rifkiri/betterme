...
export const MonthlyDashboard = () => {
  ...
  const monthlyTasks = tasks.filter(task => 
    task.dueDate && isSameMonth(task.dueDate, selectedMonth)
  );
  
  const monthlyOutputs = weeklyOutputs.filter(output => 
    output.dueDate && isSameMonth(output.dueDate, selectedMonth)
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-2 sm:p-4">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Monthly Dashboard</h1>
